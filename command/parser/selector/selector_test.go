...
func TestSelectProto(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "enum", selector: "enum_field", want: 1},
...
func TestSelectorInjector_InjectProto(t *testing.T) {
	tests := []struct {
		...
		// enum
		{name: "top level enum integer", selector: "enum_field", value: 2},
		{name: "top level enum string", selector: "enum_field", value: 2, injectValue: "TEST_ENUM_OPTION_2"},
		{name: "nested nested enum integer", selector: "recursive_field.recursive_field.enum_field", value: 2},
		{name: "nested nested enum string", selector: "recursive_field.recursive_field.enum_field", value: 2, injectValue: "TEST_ENUM_OPTION_2"},
		...
		{name: "top level map string enum int", selector: "map_string_enum_field[\"foo\"]", value: 2},
		{name: "top level map string enum string", selector: "map_string_enum_field[\"foo\"]", value: 2, injectValue: "TEST_ENUM_OPTION_2"},
