...
var invalidConfigs = []configPair{
	...
	{"PDB3000 - Invalid configuration: RaftSnapshotEntries must be >= 10", invalidSequenceSnapshotEntries()},
	...
	{"PDB3000 - Invalid configuration: RaftSnapshotEntries must be >= SequenceCompactionOverhead", sequenceCompactionGreaterThanDataSnapshotEntries()},
